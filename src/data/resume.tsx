...
export const DATA = {
  ...
  description:
    "Software Engineer with a passion for building innovative and impactful solutions",
  // summary:
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/sujalthummar",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/sujal-thummar-74589a257/",
        icon: Icons.linkedin,
  ...
  work: [
    ...
    {
      company: "Softices Academy",
      href: "https://softices.com/",
      badges: [],
      location: "Surat",
      title: "Intern Web Developer",
      logoUrl: "/softices-academy.png",
      start: "Aug 2022",
      end: "Feb 2023",
      description:
        "Gaining expertise in advanced concepts like React Hooks for efficient state and lifecycle management, Redux for centralized and scalable state management, and designing sophisticated frontend architectures that prioritize performance, modularity, and maintainability. Additionally, mastering patterns such as Context API, custom hooks, and middleware integration to build dynamic, responsive, and scalable user interfaces.",
    },
  ],
  education: [
    {
      ...
      logoUrl: "/Bhagwan Mahavir College.png",
      start: "2021",
      end: "2024",
    },
  ],
  projects: [
    {
      title: "Cowberry",
      href: "https://cowberry.world/",
      dates: "Feb 2024 - Nov 2024",
      active: true,
      description:
        "Cowberry is ecommerce site that sales grains and pulses freshly from farmer to customer 100% organic and also shares best recipes which go with it",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
    ...
    {
      title: "Carunch",
      href: "https://carunch.com/",
      dates: "June 2023 - Oct 2024",
      active: true,
      description:
        "Carunch is project about car repair and selling for the Old cars for easy and efficient service provider for automobile",
      technologies: [
        "React.js",
        "JavaScript",
        "PostgreSQL",
    ...
    },
    {
      ...
      active: true,
      description:
        "MetamorixUI is a premium Next.js with Framer Motion library offering highly animated, simple-to-use components, enabling developers to create dynamic, engaging user interfaces effortlessly.",
      technologies: [
        "Next.js",
        "Typescript",
        "TailwindCSS",
      ...
      image: "",
      video: "metamorix-ui.mov",
    },
    {
      title: "SolaX",
      href: "https://www.solax.org/",
      dates: "Mar 2023 - Aug 2023",
      active: true,
      description:
        "SOLA introduces SOLAx, a WhatsApp-based academy for Afghan girls, offering daily classwork in English, Pashto, and Dari via chatbot, requiring only a phone and basic connection.",
      technologies: [
        "React.js",
        "Typescript",
        "PostgreSQL",
